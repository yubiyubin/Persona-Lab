...
import { GOLD_RGB, PINK_RGB, PURPLE_RGB, CYAN_RGB } from "@/styles/card-themes";
      ...
      <div ref={detailRef} className="flex flex-col gap-5">
        ...
        <div className="text-center flex flex-col gap-1">
          <h1
            ...
            style={{
              color: `rgba(${GOLD_RGB},1)`,
              textShadow: `0 0 20px rgba(${GOLD_RGB},0.5), 0 0 40px rgba(${GOLD_RGB},0.2)`,
            }}
          >
            {profile.type}
          </h1>
        ...
        {/* ② 성격 요약 */}
        <NeonCard rgb={GOLD_RGB} className="p-4 sm:p-5">
          <h2 className="text-xs font-black mb-2" style={{ color: `rgba(${GOLD_RGB},0.8)` }}>
        ...
        <div className="flex flex-col gap-2">
          <h2 className="text-xs font-black" style={{ color: `rgba(${GOLD_RGB},0.7)` }}>
            {PROFILES.tagsTitle}
          </h2>
          <div className="flex flex-wrap gap-2">
            {profile.tags.map((tag) => (
              <span
                ...
                style={{
                  color: `rgba(${GOLD_RGB},0.9)`,
                  background: `rgba(${GOLD_RGB},0.1)`,
                  border: `0.5px solid rgba(${GOLD_RGB},0.3)`,
                }}
              >
                {tag}
              </span>
        ...
        {/* ⑦ 유명 인물·캐릭터 */}
        <NeonCard rgb={GOLD_RGB} className="p-4">
          <h2 className="text-xs font-black mb-3" style={{ color: `rgba(${GOLD_RGB},0.8)` }}>
            ...
            {profile.celebrities.map((name) => (
              <span
                ...
                style={{
                  ...
                  border: `0.5px solid rgba(${GOLD_RGB},0.2)`,
                }}
              >
                {name}
              </span>
