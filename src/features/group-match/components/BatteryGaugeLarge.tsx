...
const THEMES: Record<"good" | "medium" | "danger", Theme> = {
  good: {
    h: 192, s: 100, lBase: 52, lTop: 72,
    glowRgb: "0,195,255",
    borderHex: "#33d6ff",
    accentHex: "#aaf0ff",
  },
  medium: {
    h: 205, s: 90, lBase: 36, lTop: 52,
    glowRgb: "0,130,210",
    borderHex: "#22aadd",
    accentHex: "#99ddff",
  },
  danger: {
    h: 3, s: 88, lBase: 36, lTop: 52,
    glowRgb: "230,60,60",
    borderHex: "#ff6666",
    accentHex: "#ffbbbb",
  },
    ...
    <div style={{
      ...
      <div style={{ position: "relative", width, height, display: "flex", alignItems: "center" }}>
        ...
        <div style={{
          ...
          overflow: "hidden",
          boxShadow: [
            `0 0 12px rgba(${gr},${(0.80 * gp).toFixed(2)})`,
            `0 0 32px rgba(${gr},${(0.60 * gp).toFixed(2)})`,
            `0 0 72px rgba(${gr},${(0.40 * gp).toFixed(2)})`,
            `0 0 130px rgba(${gr},${(0.20 * gp).toFixed(2)})`,
        ...
        <div style={{
          ...
          border: `1.5px solid ${theme.borderHex}cc`,
          borderLeft: "none",
          backdropFilter: "blur(4px)",
          boxShadow: `3px 0 18px rgba(${gr},${(0.75 * gp).toFixed(2)}), 5px 0 40px rgba(${gr},${(0.50 * gp).toFixed(2)}), 0 0 60px rgba(${gr},${(0.30 * gp).toFixed(2)})`,
          transition: "all 0.5s",
        }} />
      </div>
      ...
      {label && (
        <p style={{
          ...
          textAlign: "center",
          margin: 0,
          textShadow: `0 0 10px rgba(${gr},${(0.65 * gp).toFixed(2)}), 0 0 24px rgba(${gr},${(0.35 * gp).toFixed(2)})`,
        }}>
          {label}
        </p>
      )}
